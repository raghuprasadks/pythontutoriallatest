...
#Importing Dataset
income = pd.read_csv("E:\\kaushalya.tech\\trainingmaterials\\python\\pythontutorial\\pandas\\income.csv");
print(income);
print(type(income))
#Get Variable Names
...
#To drop the duplicates drop_duplicates is used with default inplace = False, keep = 'first' or 'last' or 
#'False' have the respective meanings as in duplicated( )
